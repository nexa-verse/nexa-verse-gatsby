...
const IndexPage = () => {
  ...
  <Layout>
     <section className="home-hero">
        <h1 className="headline">nowoczesne i niezawodne <span className="uppercase">IT</span> <br/> <span className="smaller">to rozwój Twojej<br/> Firmy a nasza odpowiedzialność</span></h1>        
      ...
      <section className="infrascan">
        <h2> <span className="subheadline">360°InfraScan by </span><StaticImage src="../images/logo/logo_outline_light.png" placeholder="blurred" alt="Nexa Verse logo outlined" className="subheadline-logo"/></h2>
